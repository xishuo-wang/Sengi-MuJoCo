...
# 数据保存路径
CSV_DATA_DIR = r"D:\Code\Sengi-MuJoCo\Sengi-single_MuJoCo\Data_Locomotion"
...
# 最优参数
OPTIMAL_A_LEGH_HIP = 1.2
OPTIMAL_A_LEGH_KNEE = 0.1
...
ANALYSIS_END_TIME = 5
IMPULSE_START = ANALYSIS_START_TIME + 0.07
