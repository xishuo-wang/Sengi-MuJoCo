...
# ==================== 配置参数 ====================
# 数据文件路径
CSV_DATA_FILE = r"D:\Code\Sengi-MuJoCo\Sengi-single-MuJoCo\Data_Locomotion\Simulation_Data_260527_1731.csv"
...
class VisualizationController:
    ...
    def update_plot(self):
        ...
        if self.current_page == 0:
            ...
            self.show_joints(0, 4, "后肢关节状态")
        elif self.current_page == 2:
            self.show_joints(4, 7, "前肢关节状态")
